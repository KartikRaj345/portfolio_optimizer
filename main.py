from data_loader import generate_synthetic_data, train_val_test_split
...
def main():
    ...
    full_dataframe                        = generate_synthetic_data(ASSETS, n_days=1500, seed=42)
    ...
    model   = trainer.train(total_timesteps=200_000)
    ...
    comparison_table = compare_results(all_results)
